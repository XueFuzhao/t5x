...
#       print('Token Embedding is skipped')
  ...
  def apply_gradient(self, hyper_params, params, state, grads):
    ...
    new_params_flat['token_embedder/embedding'] = params_flat['token_embedder/embedding']
    new_states_flat['token_embedder/embedding'] = states_flat['token_embedder/embedding']
